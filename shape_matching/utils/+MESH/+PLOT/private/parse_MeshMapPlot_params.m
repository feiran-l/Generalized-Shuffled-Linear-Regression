...
addParameter(p,'IfSaveCoverage',default_param.IfSaveCoverage,@islogical);
addParameter(p,'IfSaveCorrectMatch',default_param.IfSaveCorrectMatch,@islogical);
...
param.IfSaveCoverage = p.Results.IfSaveCoverage;
param.IfSaveCorrectMatch = p.Results.IfSaveCorrectMatch;
